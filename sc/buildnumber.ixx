...
// LAST BUILD (CMAKE): 2024-05-08 20:14:04
...
export namespace scbuild
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t build = 995;
	
	constexpr uint32_t version = major * 10000 + minor * 1000 + build;
	constexpr uint64_t random_seed = 0x5364ea53df35f6bc;
	
	constexpr char version_string[] = "v0.0.995";
	constexpr char build_time_string[] = "2024-05-08 20:14:04";
	constexpr char phrase[] = "tricolor-ideology-upwind";
	constexpr char calver[] = "2024.19.995";
	constexpr char uuid[] = "00681446-18BB-4DF6-9265-2AFEF15DDC9B";
