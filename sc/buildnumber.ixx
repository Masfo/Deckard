...
// LAST BUILD (CMAKE): 2024-05-02 21:51:38
...
export namespace scbuild
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t build = 364;
	
	constexpr uint32_t version = major * 10000 + minor * 1000 + build;
	constexpr uint64_t random_seed = 0x8df9fe195f8e4392;
	
	constexpr char version_string[] = "v0.0.364";
	constexpr char build_time_string[] = "2024-05-02 21:51:38";
	constexpr char phrase[] = "routing-strewn-choosy";
	constexpr char calver[] = "2024.18.364";
	constexpr char uuid[] = "24D504EE-3405-4794-9926-CC8D74F24BF1";
