...
// LAST BUILD (CMAKE): 2024-05-13 17:17:35
...
export namespace scbuild
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t build = 1857;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + build;
	constexpr uint64_t random_seed = 0x3842f484d101334e;
	
	constexpr char version_string[] = "v0.0.1857";
	constexpr char build_time_string[] = "2024-05-13 17:17:35";
	constexpr char phrase[] = "vacation-unbent-imperfect";
	constexpr char calver[] = "2024.20.1857";
	constexpr char uuid[] = "111DCFFC-1A00-46AC-ABA5-C2CB620BD691";
