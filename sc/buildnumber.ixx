...
// LAST BUILD (CMAKE): 2024-05-14 18:52:03
...
export namespace scbuild::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 1986;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0x7d83159049141ae6;
	
	constexpr char version_string[] = "v0.0.1986";
	constexpr char build_time_string[] = "2024-05-14 18:52:03";
	constexpr char phrase[] = "banana-risk-yoyo";
	constexpr char calver[] = "2024.20.1986";
	constexpr char uuid[] = "D329D268-5A9E-44B8-AAE2-97BB348B6A98";
