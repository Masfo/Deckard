...
// LAST BUILD (CMAKE): 2024-05-01 13:21:42
...
export namespace scbuild
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t build = 154;
	
	constexpr uint32_t version = major * 10000 + minor * 1000 + build;
	constexpr uint64_t random_seed = 0xdbfb3b766440f4d0;
	
	constexpr char version_string[] = "v0.0.154";
	constexpr char build_time_string[] = "2024-05-01 13:21:42";
	constexpr char phrase[] = "direction-regime-broaden";
	constexpr char calver[] = "2024.18.154";
	constexpr char uuid[] = "BF425B93-5912-4A0A-BE38-DF818C502EEA";
