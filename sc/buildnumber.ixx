...
// LAST BUILD (CMAKE): 2024-05-01 11:57:51
...
export namespace scbuild
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t build = 146;
	
	constexpr uint32_t version = major * 10000 + minor * 1000 + build;
	constexpr uint64_t random_seed = 0x4e973e2495ade88c;
	
	constexpr char version_string[] = "v0.0.146";
	constexpr char build_time_string[] = "2024-05-01 11:57:51";
	constexpr char phrase[] = "direction-kiln-craftily";
	constexpr char calver[] = "2024.18.146";
	constexpr char uuid[] = "4498D730-309C-496D-ADC6-DFD185155352";
