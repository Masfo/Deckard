...
// LAST BUILD (CMAKE): 2024-05-13 21:37:44
...
export namespace scbuild::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 1883;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0x555a6f662093b92c;
	
	constexpr char version_string[] = "v0.0.1883";
	constexpr char build_time_string[] = "2024-05-13 21:37:44";
	constexpr char phrase[] = "dollop-grazing-truce";
	constexpr char calver[] = "2024.20.1883";
	constexpr char uuid[] = "6A4DA7B9-DE51-4D3D-962E-A3CF656C482A";
