...
// LAST BUILD (CMAKE): 2024-05-07 19:22:19
...
export namespace deckardBuild
{
	...
	constexpr uint32_t minor = 1;
	 ...
	 // Do not modify these
	constexpr uint32_t build = 1288;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + build;
	constexpr uint64_t random_seed = 0x1bd565cfa1d836c;
	
	constexpr char version_string[] = "v0.1.1288";
	constexpr char build_time_string[] = "2024-05-07 19:22:19";
	constexpr char phrase[] = "blabber-agency-crock";
	constexpr char calver[] = "2024.19.1288";
	constexpr char uuid[] = "56C6A52E-7C37-4263-8EC4-6FC2322F37E9";
