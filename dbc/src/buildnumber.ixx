...
// LAST BUILD (CMAKE): 2024-05-29 18:06:32
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 4014;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0x9343fc461d616732;
	
	constexpr char version_string[] = "v0.0.4014";
	constexpr char build_time_string[] = "2024-05-29 18:06:32";
	constexpr char phrase[] = "arousal-deity-outshine";
	constexpr char calver[] = "2024.22.4014";
	constexpr char uuid[] = "DCE2F508-73A7-42D5-BF38-6840A8E77904";
