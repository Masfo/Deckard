...
// LAST BUILD (CMAKE): 2024-05-24 17:58:04
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 3749;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0xc0f9d87606826209;
	
	constexpr char version_string[] = "v0.0.3749";
	constexpr char build_time_string[] = "2024-05-24 17:58:04";
	constexpr char phrase[] = "dividable-opposite-dumping";
	constexpr char calver[] = "2024.21.3749";
	constexpr char uuid[] = "E2976D3F-5F7F-4380-A1C2-C0B7878FDFD3";
