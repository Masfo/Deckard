...
// LAST BUILD (CMAKE): 2024-05-21 22:19:18
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 3358;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0x195b77cdc67ec932;
	
	constexpr char version_string[] = "v0.0.3358";
	constexpr char build_time_string[] = "2024-05-21 22:19:18";
	constexpr char phrase[] = "barrack-enzyme-kilowatt";
	constexpr char calver[] = "2024.21.3358";
	constexpr char uuid[] = "BAC1FE87-9CE7-4467-8798-7FB08ACA15F6";
