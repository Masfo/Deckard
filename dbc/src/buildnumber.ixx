...
// LAST BUILD (CMAKE): 2024-05-16 22:27:43
...
export namespace dbc::build
{
	...
	constexpr uint64_t random_seed = 0xa3add6dfa057d7e1;
	
	constexpr char version_string[] = "v0.0.2628";
	constexpr char build_time_string[] = "2024-05-16 22:27:43";
	constexpr char phrase[] = "jackpot-overcast-guacamole";
	constexpr char calver[] = "2024.20.2628";
	constexpr char uuid[] = "B8CBB067-9FDD-41F1-A553-773F0E684B36";
