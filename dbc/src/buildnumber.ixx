...
// LAST BUILD (CMAKE): 2024-05-22 10:28:31
...
export namespace dbc::build
{
	...
	constexpr uint64_t random_seed = 0xcfca175caf167a36;
	
	constexpr char version_string[] = "v0.0.3380";
	constexpr char build_time_string[] = "2024-05-22 10:28:31";
	constexpr char phrase[] = "surgery-nicotine-hardiness";
	constexpr char calver[] = "2024.21.3380";
	constexpr char uuid[] = "4E1EACA0-68E7-4A2F-A626-D38475A1E311";
