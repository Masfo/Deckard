...
// LAST BUILD (CMAKE): 2024-05-16 23:06:04
...
export namespace dbc::build
{
	...
	constexpr uint64_t random_seed = 0xb4f7b5b12bc53c14;
	
	constexpr char version_string[] = "v0.0.2645";
	constexpr char build_time_string[] = "2024-05-16 23:06:04";
	constexpr char phrase[] = "computer-pelt-area";
	constexpr char calver[] = "2024.20.2645";
	constexpr char uuid[] = "3236C5DF-3800-4209-A542-7B808CCE0AFD";
