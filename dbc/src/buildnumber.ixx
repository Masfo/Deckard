...
// LAST BUILD (CMAKE): 2024-05-21 18:48:27
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 3332;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0x1cee9563f9603a6b;
	
	constexpr char version_string[] = "v0.0.3332";
	constexpr char build_time_string[] = "2024-05-21 18:48:27";
	constexpr char phrase[] = "sacrifice-basics-utmost";
	constexpr char calver[] = "2024.21.3332";
	constexpr char uuid[] = "3CE8C49F-F88D-4762-B10B-35BE120FA15C";
