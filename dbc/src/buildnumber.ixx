...
// LAST BUILD (CMAKE): 2024-05-16 15:15:28
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 2512;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0xc62d16fb5e8cd5bf;
	
	constexpr char version_string[] = "v0.0.2512";
	constexpr char build_time_string[] = "2024-05-16 15:15:28";
	constexpr char phrase[] = "aptly-stranger-thrift";
	constexpr char calver[] = "2024.20.2512";
	constexpr char uuid[] = "435F5C12-F6AB-4288-B604-36091CEF64A8";
