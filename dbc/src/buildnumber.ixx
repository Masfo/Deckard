...
// LAST BUILD (CMAKE): 2024-06-30 15:03:08
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 4777;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0xf034fe48cb6d4896;
	
	constexpr char version_string[] = "v0.0.4777";
	constexpr char build_time_string[] = "2024-06-30 15:03:08";
	constexpr char phrase[] = "scrooge-tricycle-grading";
	constexpr char calver[] = "2024.26.4777";
	constexpr char uuid[] = "654C5139-5D52-41B9-A6F4-F7D517F723E7";
