...
// LAST BUILD (CMAKE): 2024-07-01 19:38:14
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 4789;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0x870ad534075b7aa0;
	
	constexpr char version_string[] = "v0.0.4789";
	constexpr char build_time_string[] = "2024-07-01 19:38:14";
	constexpr char phrase[] = "yin-late-facing";
	constexpr char calver[] = "2024.27.4789";
	constexpr char uuid[] = "8F5DD935-33B6-49EF-949F-FB16011D5240";
