...
// LAST BUILD (CMAKE): 2024-06-25 18:59:40
...
export namespace dbc::build
{
	...
	constexpr uint64_t random_seed = 0x5117acb65cfcb030;
	
	constexpr char version_string[] = "v0.0.4657";
	constexpr char build_time_string[] = "2024-06-25 18:59:40";
	constexpr char phrase[] = "configure-spiral-sapling";
	constexpr char calver[] = "2024.26.4657";
	constexpr char uuid[] = "63691CC9-C301-48A6-AFF4-713C664F7EDA";
