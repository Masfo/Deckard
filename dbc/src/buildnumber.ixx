...
// LAST BUILD (CMAKE): 2024-05-25 10:00:26
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 3701;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0xe10c4c1976c33e40;
	
	constexpr char version_string[] = "v0.0.3701";
	constexpr char build_time_string[] = "2024-05-25 10:00:26";
	constexpr char phrase[] = "bankbook-custody-venomous";
	constexpr char calver[] = "2024.21.3701";
	constexpr char uuid[] = "6ACC060C-B92B-49AA-BD33-3C4259BA71A9";
