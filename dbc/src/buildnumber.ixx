...
// LAST BUILD (CMAKE): 2024-05-25 11:21:52
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 3720;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0xe71767075af93fb8;
	
	constexpr char version_string[] = "v0.0.3720";
	constexpr char build_time_string[] = "2024-05-25 11:21:52";
	constexpr char phrase[] = "parka-dropout-wistful";
	constexpr char calver[] = "2024.21.3720";
	constexpr char uuid[] = "E91BDAAA-D8D8-4B4A-9213-E2BD16BC9527";
