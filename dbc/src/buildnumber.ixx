...
// LAST BUILD (CMAKE): 2024-07-02 06:59:22
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 4794;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0x33b12c2d24c5a2cd;
	
	constexpr char version_string[] = "v0.0.4794";
	constexpr char build_time_string[] = "2024-07-02 06:59:22";
	constexpr char phrase[] = "woof-voter-flagman";
	constexpr char calver[] = "2024.27.4794";
	constexpr char uuid[] = "F03C2BE3-CF10-4A31-9FBC-68622597AAF9";
