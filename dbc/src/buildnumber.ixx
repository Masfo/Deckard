...
// LAST BUILD (CMAKE): 2024-05-26 12:58:25
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 3752;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0x28885f9c00cc3b64;
	
	constexpr char version_string[] = "v0.0.3752";
	constexpr char build_time_string[] = "2024-05-26 12:58:25";
	constexpr char phrase[] = "corporal-dramatic-small";
	constexpr char calver[] = "2024.21.3752";
	constexpr char uuid[] = "BECB4496-8438-4964-922D-0963553F8956";
