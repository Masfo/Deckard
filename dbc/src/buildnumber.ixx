...
// LAST BUILD (CMAKE): 2024-05-29 16:39:06
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 4004;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0x6de3667a96484df5;
	
	constexpr char version_string[] = "v0.0.4004";
	constexpr char build_time_string[] = "2024-05-29 16:39:06";
	constexpr char phrase[] = "resident-slingshot-magazine";
	constexpr char calver[] = "2024.22.4004";
	constexpr char uuid[] = "760757E1-466D-48A2-AC3A-976705BAA8E9";
