...
// LAST BUILD (CMAKE): 2024-05-16 15:32:13
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 2530;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0x71461ed0a47a1010;
	
	constexpr char version_string[] = "v0.0.2530";
	constexpr char build_time_string[] = "2024-05-16 15:32:13";
	constexpr char phrase[] = "bankroll-promotion-authentic";
	constexpr char calver[] = "2024.20.2530";
	constexpr char uuid[] = "9A0450B5-4F15-473C-9B00-8DE79E9F0FAA";
