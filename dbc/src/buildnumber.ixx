...
// LAST BUILD (CMAKE): 2024-05-24 09:41:03
...
export namespace dbc::build
{
	...
	constexpr uint64_t random_seed = 0xbc65748f337f9d2b;
	
	constexpr char version_string[] = "v0.0.3672";
	constexpr char build_time_string[] = "2024-05-24 09:41:03";
	constexpr char phrase[] = "sensation-clothing-shifting";
	constexpr char calver[] = "2024.21.3672";
	constexpr char uuid[] = "4EE7FB98-121D-4592-9DF2-C3374053CBA5";
