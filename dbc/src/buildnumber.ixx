...
// LAST BUILD (CMAKE): 2024-07-05 21:57:09
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 4891;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0x62fca111f6828e02;
	
	constexpr char version_string[] = "v0.0.4891";
	constexpr char build_time_string[] = "2024-07-05 21:57:09";
	constexpr char phrase[] = "diligence-perfected-pointing";
	constexpr char calver[] = "2024.27.4891";
	constexpr char uuid[] = "DABAAF0E-E9C5-4366-A8C8-732F9376DF28";
