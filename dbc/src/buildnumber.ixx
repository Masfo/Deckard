...
// LAST BUILD (CMAKE): 2024-05-29 16:05:19
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 4000;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0x9409283cd816feb1;
	
	constexpr char version_string[] = "v0.0.4000";
	constexpr char build_time_string[] = "2024-05-29 16:05:19";
	constexpr char phrase[] = "deskwork-pounce-coroner";
	constexpr char calver[] = "2024.22.4000";
	constexpr char uuid[] = "8BFD170A-0C98-4AB4-954D-663A1AAEAE82";
