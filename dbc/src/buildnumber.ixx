...
// LAST BUILD (CMAKE): 2024-06-14 08:18:59
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 4367;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0x1433635c85d1fa1e;
	
	constexpr char version_string[] = "v0.0.4367";
	constexpr char build_time_string[] = "2024-06-14 08:18:59";
	constexpr char phrase[] = "activator-maimed-cheer";
	constexpr char calver[] = "2024.24.4367";
	constexpr char uuid[] = "A88F4815-FCB7-401E-9C70-BF8C3FC6FED7";
