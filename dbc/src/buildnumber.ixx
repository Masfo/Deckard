...
// LAST BUILD (CMAKE): 2024-05-16 16:56:51
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 2565;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0x73c002c38dda10a9;
	
	constexpr char version_string[] = "v0.0.2565";
	constexpr char build_time_string[] = "2024-05-16 16:56:51";
	constexpr char phrase[] = "shorter-stopping-earpiece";
	constexpr char calver[] = "2024.20.2565";
	constexpr char uuid[] = "D8555FD8-3369-479F-94AC-708BF3D446A4";
