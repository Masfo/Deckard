...
// LAST BUILD (CMAKE): 2024-05-25 09:10:21
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 3697;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0xe980de6da20d7493;
	
	constexpr char version_string[] = "v0.0.3697";
	constexpr char build_time_string[] = "2024-05-25 09:10:21";
	constexpr char phrase[] = "leverage-private-juncture";
	constexpr char calver[] = "2024.21.3697";
	constexpr char uuid[] = "C04E4F09-6ACC-4C6A-9B2B-8AA6CE25DDE9";
