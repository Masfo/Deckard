...
// LAST BUILD (CMAKE): 2024-06-27 20:21:49
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 4684;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0xfbf246ee42bc6b26;
	
	constexpr char version_string[] = "v0.0.4684";
	constexpr char build_time_string[] = "2024-06-27 20:21:49";
	constexpr char phrase[] = "glacier-publisher-gooey";
	constexpr char calver[] = "2024.26.4684";
	constexpr char uuid[] = "0121AF69-344C-4AA8-AA6A-2C72278E69B6";
