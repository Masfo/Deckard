...
// LAST BUILD (CMAKE): 2024-06-22 11:13:50
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 4594;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0xc360f2e4dd1b0eaa;
	
	constexpr char version_string[] = "v0.0.4594";
	constexpr char build_time_string[] = "2024-06-22 11:13:50";
	constexpr char phrase[] = "eastcoast-magnitude-essence";
	constexpr char calver[] = "2024.25.4594";
	constexpr char uuid[] = "4FEC74E5-80E2-4AC9-AC5E-029AD81F653A";
