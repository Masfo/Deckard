...
// LAST BUILD (CMAKE): 2024-07-02 16:52:02
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 4801;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0x3f635eb92fe5f65b;
	
	constexpr char version_string[] = "v0.0.4801";
	constexpr char build_time_string[] = "2024-07-02 16:52:02";
	constexpr char phrase[] = "grunt-spinout-monotype";
	constexpr char calver[] = "2024.27.4801";
	constexpr char uuid[] = "8A005257-2A02-4D8C-A14D-A28DFD7890C0";
