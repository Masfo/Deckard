...
// LAST BUILD (CMAKE): 2024-06-23 18:02:48
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 4642;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0x20878a4941d9dc0a;
	
	constexpr char version_string[] = "v0.0.4642";
	constexpr char build_time_string[] = "2024-06-23 18:02:48";
	constexpr char phrase[] = "magnitude-unmixed-squeamish";
	constexpr char calver[] = "2024.25.4642";
	constexpr char uuid[] = "11E7753A-4B2B-4F33-B72F-D27FA6498DAC";
