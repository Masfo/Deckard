...
// LAST BUILD (CMAKE): 2024-07-02 06:54:37
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 4792;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0x78c321ef0607284b;
	
	constexpr char version_string[] = "v0.0.4792";
	constexpr char build_time_string[] = "2024-07-02 06:54:37";
	constexpr char phrase[] = "streak-cross-satirical";
	constexpr char calver[] = "2024.27.4792";
	constexpr char uuid[] = "F13437A3-690F-4A8D-A3C4-CBED5DECD233";
