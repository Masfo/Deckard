...
// LAST BUILD (CMAKE): 2024-05-15 23:50:50
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 2393;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0x8bbdb782257a451b;
	
	constexpr char version_string[] = "v0.0.2393";
	constexpr char build_time_string[] = "2024-05-15 23:50:50";
	constexpr char phrase[] = "impotency-guacamole-singular";
	constexpr char calver[] = "2024.20.2393";
	constexpr char uuid[] = "2F3C9EDE-97D6-472D-BD27-7F18287C835E";
