...
// LAST BUILD (CMAKE): 2024-05-16 16:14:43
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 2557;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0xcd1df79de401c9c9;
	
	constexpr char version_string[] = "v0.0.2557";
	constexpr char build_time_string[] = "2024-05-16 16:14:43";
	constexpr char phrase[] = "proactive-implement-glacial";
	constexpr char calver[] = "2024.20.2557";
	constexpr char uuid[] = "53E5AF59-DC13-4F87-8908-03E9DABBA2A4";
