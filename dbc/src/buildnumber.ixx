...
// LAST BUILD (CMAKE): 2024-05-15 10:07:02
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 2061;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0x63efa57281cc0a45;
	
	constexpr char version_string[] = "v0.0.2061";
	constexpr char build_time_string[] = "2024-05-15 10:07:02";
	constexpr char phrase[] = "stray-storable-seminar";
	constexpr char calver[] = "2024.20.2061";
	constexpr char uuid[] = "E7888B17-A465-4D5B-A9F5-6E92CBC71253";
