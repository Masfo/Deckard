...
// LAST BUILD (CMAKE): 2024-05-25 10:59:31
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 3715;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0xb5a900a8fd57a052;
	
	constexpr char version_string[] = "v0.0.3715";
	constexpr char build_time_string[] = "2024-05-25 10:59:31";
	constexpr char phrase[] = "amiable-snowshoe-veto";
	constexpr char calver[] = "2024.21.3715";
	constexpr char uuid[] = "D75AF2C7-2BDE-412C-96AF-59AC6CAE4B6C";
