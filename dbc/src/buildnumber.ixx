...
// LAST BUILD (CMAKE): 2024-06-29 12:48:31
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 4747;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0x5494aca5777b8b2e;
	
	constexpr char version_string[] = "v0.0.4747";
	constexpr char build_time_string[] = "2024-06-29 12:48:31";
	constexpr char phrase[] = "reminder-pulp-ricotta";
	constexpr char calver[] = "2024.26.4747";
	constexpr char uuid[] = "185D2CD6-801C-459B-A81B-6707CAFA0C3D";
