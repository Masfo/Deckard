...
// LAST BUILD (CMAKE): 2024-05-27 13:15:25
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 3842;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0x444e0c9d93857983;
	
	constexpr char version_string[] = "v0.0.3842";
	constexpr char build_time_string[] = "2024-05-27 13:15:25";
	constexpr char phrase[] = "critter-dicing-tableware";
	constexpr char calver[] = "2024.22.3842";
	constexpr char uuid[] = "B4638EE6-F54E-49CA-AC54-FD987AACF994";
