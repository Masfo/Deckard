...
// LAST BUILD (CMAKE): 2024-08-16 06:35:17
...
export namespace dbc::build
{
	...
	constexpr uint64_t random_seed = 0x5742d7fb5f234778;
	
	constexpr char version_string[] = "v0.0.6436";
	constexpr char build_time_string[] = "2024-08-16 06:35:17";
	constexpr char phrase[] = "abreast-porthole-tattling";
	constexpr char calver[] = "2024.33.6436";
	constexpr char uuid[] = "5A81CF77-E746-4874-939A-8A617082633D";
