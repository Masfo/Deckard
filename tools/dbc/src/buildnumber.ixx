...
// LAST BUILD (CMAKE): 2024-08-10 10:21:26
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 6286;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0x8d8c3f597211abbc;
	
	constexpr char version_string[] = "v0.0.6286";
	constexpr char build_time_string[] = "2024-08-10 10:21:26";
	constexpr char phrase[] = "carton-freely-eleven";
	constexpr char calver[] = "2024.32.6286";
	constexpr char uuid[] = "5C91E954-FDBD-4EE8-9938-DCDD3E5472CB";
