...
// LAST BUILD (CMAKE): 2024-08-04 12:45:31
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 5882;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0xc1c07bf697a5610;
	
	constexpr char version_string[] = "v0.0.5882";
	constexpr char build_time_string[] = "2024-08-04 12:45:31";
	constexpr char phrase[] = "ocean-uninvited-plentiful";
	constexpr char calver[] = "2024.31.5882";
	constexpr char uuid[] = "3C3870AF-CB65-4794-A936-0E145A79A0D1";
