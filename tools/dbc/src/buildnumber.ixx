...
// LAST BUILD (CMAKE): 2024-08-07 19:05:32
...
export namespace dbc::build
{
	...
	constexpr uint64_t random_seed = 0xd5639ec11ee6e665;
	
	constexpr char version_string[] = "v0.0.6094";
	constexpr char build_time_string[] = "2024-08-07 19:05:32";
	constexpr char phrase[] = "unsubtly-tiny-finisher";
	constexpr char calver[] = "2024.32.6094";
	constexpr char uuid[] = "9CEF355F-151B-4E7C-B929-367D4D6390AD";
