...
// LAST BUILD (CMAKE): 2024-07-30 07:38:55
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 5642;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0xbe2385a4a6132687;
	
	constexpr char version_string[] = "v0.0.5642";
	constexpr char build_time_string[] = "2024-07-30 07:38:55";
	constexpr char phrase[] = "tavern-clunky-exalted";
	constexpr char calver[] = "2024.31.5642";
	constexpr char uuid[] = "FEEFF827-9979-490C-89F9-D8BA9B98F150";
