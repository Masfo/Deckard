...
// LAST BUILD (CMAKE): 2024-08-09 20:35:39
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 6179;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0xe8dd6bbc7eb87e0;
	
	constexpr char version_string[] = "v0.0.6179";
	constexpr char build_time_string[] = "2024-08-09 20:35:39";
	constexpr char phrase[] = "icon-tinfoil-unpeeled";
	constexpr char calver[] = "2024.32.6179";
	constexpr char uuid[] = "5E6782FD-5239-43EF-812E-BBA39AA81973";
