...
// LAST BUILD (CMAKE): 2024-07-26 06:27:51
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 5547;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0xd320cbce68e6d4f3;
	
	constexpr char version_string[] = "v0.0.5547";
	constexpr char build_time_string[] = "2024-07-26 06:27:51";
	constexpr char phrase[] = "replace-moneybags-student";
	constexpr char calver[] = "2024.30.5547";
	constexpr char uuid[] = "A8EF1619-756D-4305-B593-C796B266B0DB";
