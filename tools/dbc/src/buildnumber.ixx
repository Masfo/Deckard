...
// LAST BUILD (CMAKE): 2024-07-27 10:28:31
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 5588;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0xcf2b3b94836238d9;
	
	constexpr char version_string[] = "v0.0.5588";
	constexpr char build_time_string[] = "2024-07-27 10:28:31";
	constexpr char phrase[] = "subsector-enduring-catatonic";
	constexpr char calver[] = "2024.30.5588";
	constexpr char uuid[] = "A2AF56FE-3CE0-4647-8102-3713D3A00A82";
