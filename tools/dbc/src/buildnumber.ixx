...
// LAST BUILD (CMAKE): 2024-07-12 21:31:11
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 5094;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0xbafd5e9275688ea8;
	
	constexpr char version_string[] = "v0.0.5094";
	constexpr char build_time_string[] = "2024-07-12 21:31:11";
	constexpr char phrase[] = "outbreak-sternum-murmuring";
	constexpr char calver[] = "2024.28.5094";
	constexpr char uuid[] = "81172BF1-5124-4FD4-96F8-CA9888C2FE4F";
