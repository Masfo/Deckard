...
// LAST BUILD (CMAKE): 2024-08-09 21:21:27
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 6216;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0x6e5ac5b041ea61aa;
	
	constexpr char version_string[] = "v0.0.6216";
	constexpr char build_time_string[] = "2024-08-09 21:21:27";
	constexpr char phrase[] = "enjoyably-headcount-upstate";
	constexpr char calver[] = "2024.32.6216";
	constexpr char uuid[] = "70FE3209-87D8-4312-9D6F-CB0A6FADEFAE";
