...
// LAST BUILD (CMAKE): 2024-08-10 19:47:49
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 6306;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0x1a81581538f66ac4;
	
	constexpr char version_string[] = "v0.0.6306";
	constexpr char build_time_string[] = "2024-08-10 19:47:49";
	constexpr char phrase[] = "grumbling-shading-trapdoor";
	constexpr char calver[] = "2024.32.6306";
	constexpr char uuid[] = "D8A0D9A7-857A-44A5-AD64-C2821DF58760";
