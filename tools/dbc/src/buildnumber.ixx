...
// LAST BUILD (CMAKE): 2024-08-10 12:01:33
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 6288;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0xad907c08d9121f55;
	
	constexpr char version_string[] = "v0.0.6288";
	constexpr char build_time_string[] = "2024-08-10 12:01:33";
	constexpr char phrase[] = "probe-papyrus-attention";
	constexpr char calver[] = "2024.32.6288";
	constexpr char uuid[] = "8040036A-AFF0-4376-98B0-918971C68BD5";
