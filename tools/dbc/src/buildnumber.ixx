...
// LAST BUILD (CMAKE): 2024-08-05 20:51:19
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 6009;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0xd99244d81b7fa9e1;
	
	constexpr char version_string[] = "v0.0.6009";
	constexpr char build_time_string[] = "2024-08-05 20:51:19";
	constexpr char phrase[] = "traffic-scabby-override";
	constexpr char calver[] = "2024.32.6009";
	constexpr char uuid[] = "BACCB8A1-B05A-4484-BE7E-431EA8A1C91B";
