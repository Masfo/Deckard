...
// LAST BUILD (CMAKE): 2024-07-24 06:59:10
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 5489;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0x57082d1ea5618a7a;
	
	constexpr char version_string[] = "v0.0.5489";
	constexpr char build_time_string[] = "2024-07-24 06:59:10";
	constexpr char phrase[] = "outright-juvenile-detector";
	constexpr char calver[] = "2024.30.5489";
	constexpr char uuid[] = "6665AF9B-B71F-47DC-BF0C-19D214A683CE";
