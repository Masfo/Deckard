...
// LAST BUILD (CMAKE): 2024-07-30 21:43:54
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 5681;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0xe4fd1b57e26a4c2c;
	
	constexpr char version_string[] = "v0.0.5681";
	constexpr char build_time_string[] = "2024-07-30 21:43:54";
	constexpr char phrase[] = "eel-backhand-trapping";
	constexpr char calver[] = "2024.31.5681";
	constexpr char uuid[] = "0003D26C-8BFB-4DB4-8303-1F80F2BEE289";
