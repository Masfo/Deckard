...
// LAST BUILD (CMAKE): 2024-08-10 11:27:20
...
export namespace dbc::build
{
	...
	constexpr uint64_t random_seed = 0xa970fcd36debcd2a;
	
	constexpr char version_string[] = "v0.0.6287";
	constexpr char build_time_string[] = "2024-08-10 11:27:20";
	constexpr char phrase[] = "syndrome-passcode-stoneware";
	constexpr char calver[] = "2024.32.6287";
	constexpr char uuid[] = "6B7017DA-2BC9-468C-96B0-3054BE4A8CDB";
