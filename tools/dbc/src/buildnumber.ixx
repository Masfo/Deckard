...
// LAST BUILD (CMAKE): 2024-08-09 08:36:09
...
export namespace dbc::build
{
	...
	constexpr uint64_t random_seed = 0xc2ab94570f2b5722;
	
	constexpr char version_string[] = "v0.0.6118";
	constexpr char build_time_string[] = "2024-08-09 08:36:09";
	constexpr char phrase[] = "mousiness-serpent-headlock";
	constexpr char calver[] = "2024.32.6118";
	constexpr char uuid[] = "C7CA3C99-DB81-46F2-B917-B0579C240F99";
