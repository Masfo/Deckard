...
// LAST BUILD (CMAKE): 2024-07-07 19:22:39
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 4996;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0xeb2bc3a752fba08e;
	
	constexpr char version_string[] = "v0.0.4996";
	constexpr char build_time_string[] = "2024-07-07 19:22:39";
	constexpr char phrase[] = "rind-capillary-broadways";
	constexpr char calver[] = "2024.27.4996";
	constexpr char uuid[] = "9061EA45-C1AB-410F-A3AC-06D235AF432B";
