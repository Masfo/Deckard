...
// LAST BUILD (CMAKE): 2024-08-07 19:42:13
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 6099;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0x555f0921f3330d50;
	
	constexpr char version_string[] = "v0.0.6099";
	constexpr char build_time_string[] = "2024-08-07 19:42:13";
	constexpr char phrase[] = "uprising-flying-detail";
	constexpr char calver[] = "2024.32.6099";
	constexpr char uuid[] = "9232957B-B4AA-4C44-9E85-C7BB5A807DDA";
