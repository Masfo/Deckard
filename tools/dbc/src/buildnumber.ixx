...
// LAST BUILD (CMAKE): 2024-07-27 14:04:10
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 5593;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0x9133e5e25ce3bef4;
	
	constexpr char version_string[] = "v0.0.5593";
	constexpr char build_time_string[] = "2024-07-27 14:04:10";
	constexpr char phrase[] = "lyricism-consuming-repugnant";
	constexpr char calver[] = "2024.30.5593";
	constexpr char uuid[] = "40FDCE57-1C99-4E2F-B18C-3ED1E4F423AA";
