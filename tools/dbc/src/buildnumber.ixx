...
// LAST BUILD (CMAKE): 2024-07-28 19:31:34
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 5598;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0xf90222e986b3ea62;
	
	constexpr char version_string[] = "v0.0.5598";
	constexpr char build_time_string[] = "2024-07-28 19:31:34";
	constexpr char phrase[] = "grapple-underfed-pureblood";
	constexpr char calver[] = "2024.30.5598";
	constexpr char uuid[] = "E55EBB21-22B2-442F-BBC3-A33BAA39A8FE";
