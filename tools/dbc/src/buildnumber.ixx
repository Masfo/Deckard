...
// LAST BUILD (CMAKE): 2024-08-06 08:02:57
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 6021;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0x1692eec086e0536b;
	
	constexpr char version_string[] = "v0.0.6021";
	constexpr char build_time_string[] = "2024-08-06 08:02:57";
	constexpr char phrase[] = "refueling-jinx-wiring";
	constexpr char calver[] = "2024.32.6021";
	constexpr char uuid[] = "D925C274-5B45-460C-A903-5AC92774A862";
