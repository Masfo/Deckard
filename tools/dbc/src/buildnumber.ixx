...
// LAST BUILD (CMAKE): 2024-08-02 22:45:46
...
export namespace dbc::build
{
	...
	constexpr uint64_t random_seed = 0x2c5f79e753e29d4c;
	
	constexpr char version_string[] = "v0.0.5805";
	constexpr char build_time_string[] = "2024-08-02 22:45:46";
	constexpr char phrase[] = "scabbed-dipped-spectacle";
	constexpr char calver[] = "2024.31.5805";
	constexpr char uuid[] = "81DCEE05-B5DB-484B-B4C2-EECCA43444C7";
