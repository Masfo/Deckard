...
// LAST BUILD (CMAKE): 2024-08-06 07:51:00
...
export namespace dbc::build
{
	...
	constexpr uint32_t minor = 0;
	 ...
	 // Do not modify these
	constexpr uint32_t patch = 6019;
	
	constexpr uint32_t version = major * 100000 + minor * 10000 + patch;
	constexpr uint64_t random_seed = 0x8ced3562ba2572aa;
	
	constexpr char version_string[] = "v0.0.6019";
	constexpr char build_time_string[] = "2024-08-06 07:51:00";
	constexpr char phrase[] = "despise-unproven-trio";
	constexpr char calver[] = "2024.32.6019";
	constexpr char uuid[] = "6B8FE5C4-5C8F-421C-B474-26F8A6FFB9D6";
